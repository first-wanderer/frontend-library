...
* [Prosto Forms](http://prostoforms.workforfood.pro/) - фреймворк для оформления форм.
...
* [Gridlex](http://gridlex.devlint.fr/) - система сеток, работающая на flexbox.
...
* [parallax.js](http://matthew.wagerfield.com/parallax/) - плагин для создания параллакс-эффекта.
* [fullPage.js](http://alvarotrigo.com/fullPage/#firstPage) - плагин для прокрутки в виде слайдов.
* [FSVS](http://luke.sno.wden.co.uk/full-screen-vertical-scroll#fsvs-initial-setup) - плагин для вертикальной прокрутки в виде слайдов.
* [pagePiling.js](http://alvarotrigo.com/pagePiling/#page1) - и еще один плагин для вертикальной прокрутки в виде слайдов.
* [Minigrid](http://alves.im/minigrid/) - плагин для расположения блоков разной высоты рядом друг с другом.
* [Justified.js](http://nitinhayaran.github.io/Justified.js/demo/index.html) - плагин для заполнения области изображениями.
* [MixitUp](https://mixitup.kunkalabs.com/) - плагин для сортировки плиточек.
* [Crosscover](http://git.blivesta.com/crosscover/) - плагин для создания карусели.
* [Flat slider](http://lugolabs.com/flat-slider) - управляющий элемент фильтра цены на jQuery.
* [Guardian](http://jquery.michaeleisenbraun.com/guardian/) - библиотека для валидации форм на jQuery.
* [Plyr](https://plyr.io/) - простой и доступный HTML5 media player.
* [VideoJS](http://videojs.com/) - HTML5 video player.
* [Midnight.js](http://aerolab.github.io/midnight.js/) - плагин для замены фиксированных заголовков на лету.

### Готовые реализации (с использованием JS)
...
* [Image Comparison Slider](https://codyhouse.co/demo/image-comparison-slider/index.html) - разделенное пополам изображение.
* [Prism Effect Slider with Canvas](http://tympanus.net/Tutorials/PrismEffectSlider/index3.html) - эффект на слайдере с помощью SVG-подложки.
* [Password Strength meter](https://css-tricks.com/password-strength-meter/) - индикатор надежности пароля.
...
* [Sass Guidelines](http://sass-guidelin.es/ru/) - Руководство по написанию разумного, поддерживаемого и масштабируемого Sass (на русском).
...
* [Sassisfaction](http://sassisfaction.com/) - подборка материалов по SASS, на SASS и для SASS.
...
* [Unsemantic](http://unsemantic.com/sass-documentation) - адаптивная система сеток на SASS.
* [Avalanche](http://colourgarden.net/avalanche/) - адаптивная система сеток на SASS с BEM-синтаксисом.
